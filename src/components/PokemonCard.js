...
//     const { favouritePokemon, addFavouritePokemon, removeFavouritePokemon, isFavouritePokemon, isMaxFavouriteCount } = useFavouritePokemon(id);
//     // const [showModal, closeModal, handleFavouriteToggle] = useMaxFavouritePokemon(6);

//     console.log("isMaxFavouriteCount", isMaxFavouriteCount)

//     const handleToggleFavourite = isFavouritePokemon ? removeFavouritePokemon : addFavouritePokemon;
...
//                     <FavoriteButton isFavourite={isFavouritePokemon} onToggle={handleToggleFavourite} isMaxFavouriteCount={isMaxFavouriteCount} />
